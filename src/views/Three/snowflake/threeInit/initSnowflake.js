...
export default (threeRef) => {
    ...
    const sprite1 = textureLoader.load('threeImg/snowflake1.png')
    const sprite2 = textureLoader.load('threeImg/snowflake2.png')
    const sprite3 = textureLoader.load('threeImg/snowflake3.png')
    const sprite4 = textureLoader.load('threeImg/snowflake4.png')
    const sprite5 = textureLoader.load('threeImg/snowflake5.png')
    ...
    const onPointerMove = (event) => {
        ...
        mouseX = event.clientX - domWidth / 2;
        mouseY = event.clientY - domHeight / 2;
    }
